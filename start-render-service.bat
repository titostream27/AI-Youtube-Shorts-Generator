...
set RENDER_LAYOUT_BLUR_AMOUNT=0.2
rem Phase 2 (Master Task Brief §21): preview rendering defaults
set RENDER_PREVIEW_WIDTH=540
set RENDER_PREVIEW_HEIGHT=960
set RENDER_PREVIEW_CRF=26
set RENDER_PREVIEW_PRESET=veryfast
rem Phase 2 (§19): job persistence DB
set RENDER_JOB_DB=rendered\render_jobs.db
